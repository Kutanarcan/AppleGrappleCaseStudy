...
namespace LoopGamesCaseStudy.AppleGrappleClone
{
    public sealed class GameFeedback : IGameFeedback
    {
        ...
        public void SwordClash(Sword a, Sword b, Vector2 point)
        {
            ...
            _particles.Play(ParticleType.SwordClash, point);

            if (!BelongsToPlayer(a) && !BelongsToPlayer(b))
                return;

            _screenShake.Play(_config.ClashShake);
        }

        private static bool BelongsToPlayer(Sword sword) => sword != null && sword.Owner != null && sword.Owner.IsPlayer;
        ...
        public void CharacterHit(Character target, Vector2 point)
        {
            ...
            _particles.Play(ParticleType.BloodSplash, point, angle);
        }

        public void Collected(Vector2 point) => _audio.PlaySFX(_config.CollectClip, _config.CollectVolume);
    }
}
