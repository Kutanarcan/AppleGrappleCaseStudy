...
namespace LoopGamesCaseStudy.AppleGrappleClone
{
    ...
    public sealed class SwordCollectibleSpawner : IDisposable
    {
        ...
        public void Update(float deltaTime)
        {
            ...
            if (CountAvailable() >= _settings.MaxActive)
                return;
        ...
        public SwordCollectible Spawn()
        {
            ...
            collectible.Initialize(_map.Next(SpawnCategoryType.Collectible), _settings.SwordAmount);
        ...
        private void SweepConsumed(float deltaTime)
        {
            ...
            for (int i = 0; i < _active.Count; i++)
            {
                ...
                if (_active[i].IsConsumeFinished)
                    _sweep.Add(_active[i]);
            }
